...
import com.example.bottombar.databinding.NavigationCellBinding


@Suppress("unused")
class CustomBottomNavigationCell @JvmOverloads constructor(
    context: Context,
    ...
    private val binding = DataBindingUtil.inflate<NavigationCellBinding>(
        LayoutInflater.from(context),
        R.layout.navigation_cell,
        this,
        true
    )
